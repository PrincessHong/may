...
<body>
	...
	<div id="data-content">
		<div class="row">
			<form id="rawScoreForm" action="age4_Action" method="post"
				...
				<div id="basic-info" class="row">
					<div class="edition">
						...
						<ul class="nav nav-tabs line pull-right" role="tablist">
							<li role="presentation"><a href="child4.jsp">儿童资料</a>
							</li>
							<li role="presentation" class="active"><a href="data4.jsp">原始分数</a>
							</li>
						</ul>
					</div>
	...
	<script>
		function plus() {
			...
			var cas = $('#cas').val();
			if (car != "" && cas != "") {
				var ca = parseInt(car) + parseInt(cas);
				$('#ca').val(ca);
			} else {
				console.log('wrong');
			}
