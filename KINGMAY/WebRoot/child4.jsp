	...
	<div id="data-content">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<form id="childInfoForm" action="addChildAction.action"
					...
					<div id="basic-info" class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 ">
									<div class="btn-group">
										<select id="cClass" name="c.cclass" class="form-control" required>
											<option ></option>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control date" id="cTYear"
										...
										required>月 <input type="text"
										class="form-control date" id="cTDay" name="c.ctday" required>日
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control date" id="cBYear"
										...
										required>月 <input type="text"
										class="form-control date" id="cBDay" name="c.cbday" required>日
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="btn-group">
										<select id="cCultrue" name="c.cculture" class="form-control" required>
											<option></option>
