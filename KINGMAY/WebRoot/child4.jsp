				...
				<div id="basic-info" class="row">
					<div class="edition">
						...
						<ul class="nav nav-tabs line pull-right" role="tablist">
							<li role="presentation" class="active"><a href="child4.jsp">儿童资料</a>
							</li>
							<li role="presentation"><a href="data4.jsp">原始分数</a></li>
						</ul>
					</div>
					<h4>
						<b>儿童基本信息</b>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label for="cName" class="col-sm-4 control-label">儿童姓名</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="cTestName" class="col-sm-4 control-label">主试姓名</label>
							<div class="col-sm-8">
