				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" id="pnotify"
							placeholder="" value="${p.pnotify }" name="p.pnotify">
					</div>
				</div>
				<input type="hidden" name="p.pid" value="${p.pid }">
