			...
			<form id="adminUserForm" action="manager/adminUserAction"
				...
				<table class="table table-bordered table-condensed">
					...
					<tr>
						...
						<td class="original">
						<span>可使用</span><input type="number"
						...
						<span>可使用</span>
						<input type="number"
							class="form-control" name="u.ucanuse" id="ucanuse4"
							style="width:88px" value="${u.ucanuse4 }" disabled> <span>增加</span>
					...
					<tr>
						<td >备注</td>
						<td colspan="3"><textarea rows="2" class="form-control" id="ubei"
