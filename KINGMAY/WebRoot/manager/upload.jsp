...
<jsp:include page="common.jsp"></jsp:include>
	<div data-options="region:'center',title:'',iconCls:'icon-ok'" class="centerLayout">
		...
		<div id="datamain" class="container">
			<div class="row">
				<ul class="list-group clearfix"></ul>
				<form action="manager/uploadAction" method="post" enctype="multipart/form-data" name="upload">
				...
				<%
							if(request.getAttribute("up4msg")!=null){
								out.println(request.getAttribute("up4msg"));
							}
				%>
			</div>
		</div>
		...
		$(function() { // 立即执行函数，避免命名冲突
			...
			upload = document.forms['upload']['upload'],
