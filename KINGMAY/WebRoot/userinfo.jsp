				...
				<div class="col-md-10">
					...
					<form class="form-horizontal" role="form" action = "changeInfoAction" method="post">
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-4 control-label">主试编号</label>
								<div class="col-sm-8">
									<p class="form-control-static">${u.uid }</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">可用记分服务数</label>
								<div class="col-sm-8">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="email" class="form-control" id="uemail" placeholder="邮箱" name="u.uemail" value=${u.uemail } >
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">公司主页</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="ucom" name="u.ucom" value=${u.ucom } placeholder="公司主页" >
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">已用记分服务数</label>
								<div class="col-sm-8">
